...
function Help(props) {
  ...
  var tooltipId = _shortid2.default.generate();
  if (!help) {
    // See #312: Ensure compatibility with old versions of React.
    return _react2.default.createElement("div", null);
  }
  if (typeof help === "string") {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        "a",
        { className: "help-tooltip", "data-tip": true, "data-for": tooltipId },
        _react2.default.createElement(
          "span",
          null,
          "?"
      ...
      _react2.default.createElement(
        ...
        { id: tooltipId, place: "top", type: "light", effect: "solid" },
        help
      )
    );
  }
...
function DefaultTemplate(props) {
  ...
  return _react2.default.createElement(
    ...
    displayLabel && _react2.default.createElement(Label, { label: label, required: required, help: help, id: id }),
...
function SchemaFieldRender(props) {
  ...
  var id = idSchema.$id;
  var label = uiSchema["ui:title"] || props.schema.title || schema.title;
